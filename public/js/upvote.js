...
"use strict";
    ...
    ////////////////////////////////////////
    // Question Voting
    $('.vote_pertanyaan').upvote();
    $('.vote_q').on('click', function (e) {
        //
        var data = {vote: $(this).data('vote'), pertanyaan_id: $(this).parent().data('question')};
        var uid = $(this).parent().data('uid');
        var rep = $(this).parent().data('reputasi');
        console.log(data,uid,rep);
    ...
    // // Answer Voting
    $(".vote_jawaban").upvote();
    $('.vote_a').on('click', function (e) {
        //
        var data = {vote: $(this).data('vote'), jawaban_id: $(this).parent().data('jawaban'),prt_id:$(this).parent().data('pertanyaan')};
        var uid = $(this).parent().data('uid');
        var rep = $(this).parent().data('reputasi');
        console.log(data,uid,rep);

        if ($(this).parent().data('jawaban')) {
